...
namespace NewStoreFront.UI.MVC.Controllers
{
    ...
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(NewStoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Suppliers != null ? 
                          ...
                          Problem("Entity set 'NewStoreFrontContext.Suppliers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NewStoreFrontContext.Suppliers'  is null.");
            }
            var supplier = await _context.Suppliers.FindAsync(id);
            if (supplier != null)
            {
