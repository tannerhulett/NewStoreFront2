...
namespace NewStoreFront.UI.MVC.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(NewStoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'NewStoreFrontContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NewStoreFrontContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
