...
namespace NewStoreFront.UI.MVC.Controllers
{
    ...
    public class UserDetailsController : Controller
    {
        ...
        public UserDetailsController(NewStoreFrontContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserDetails != null ? 
                          ...
                          Problem("Entity set 'NewStoreFrontContext.UserDetails'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'NewStoreFrontContext.UserDetails'  is null.");
            }
            var userDetail = await _context.UserDetails.FindAsync(id);
            if (userDetail != null)
            {
