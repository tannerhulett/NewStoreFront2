...
namespace NewStoreFront.UI.MVC.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(NewStoreFrontContext context)
        {
            _context = context;
        }
        ...
        {
            var newStoreFrontContext = _context.Orders.Include(o => o.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NewStoreFrontContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
